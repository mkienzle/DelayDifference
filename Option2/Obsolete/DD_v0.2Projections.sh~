...
# USAGE DDprojections_v0.2.sh FixedWeeklyParameters.txt Results/ParameterEstimates.txt Data/WeeklyPercentageOfSpawners.txt Results/LinearizedRickerCoef Data/AverageEffortPattern.txt Data/Availability.txt
...
do echo $i;
DD_v0.2Projections $1 /tmp/ParEstimates.txt $3 $4 $5 $6 $i;
