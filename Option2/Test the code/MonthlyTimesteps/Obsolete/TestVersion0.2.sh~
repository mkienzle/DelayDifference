...
# PURPOSE assess the capacity of the monthly delay difference model using MINUIT and coded in C++ to estimate parameters used to generate simulated datasets
...
#FitMonthlyDelayDifference_v0.2 Data/SimData4.txt
