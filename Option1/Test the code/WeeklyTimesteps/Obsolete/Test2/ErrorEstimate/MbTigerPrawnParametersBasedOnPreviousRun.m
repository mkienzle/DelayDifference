...
global timesteps;
years = 2001:2010; % 2001 to 2010 are simulated data going from week 1 to week 52 
...
%%% Initial biomasses provided by previous run
tmpBio=csvread('../Results/EstimatedBiomass.csv');
Biomass(1) = tmpBio(521);
Biomass(2) = tmpBio(522);
