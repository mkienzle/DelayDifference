...
// COMPILE g++ -std=c++0x -g -o WeeklyDDprojections2 -I/usr/include /usr/lib/prob.o Projections2.cxx vonMisesRecDist.cxx WeeklyDDprojections2.cpp
...
int main(int argc, char *argv[]){
  ...
  const int NbYear = 150;
    ...
    Projections2(NbYear*NWPY, n, NontargetedEffort, Par, PropMature, SrPar, FishingPattern, Availability);
