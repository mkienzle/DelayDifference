...
// USAGE DD_Option3Projections_forMDPWithEffortLimits Results/DelayDifferenceModelParameters.csv Data/WeeklyPercentageOfSpawners.txt Results/LinearizedBevertonAndHoltCoef Data/AverageEffortPattern.txt Data/Availability.txt 100 1000 2000
...
//std::cout << "Read in " << PropMature.size() << " proportion of sexually mature biomass\n";
    ...
    Projections2_forMDPWithEffortLimits(NbYear*NIPY, Lowern, Uppern, NontargetedEffort, ModelInputParameters, PropMature, SrPar, FishingPattern, Availability);
