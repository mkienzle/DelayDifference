...
// USAGE ./FitWeeklyDelayDifference_v0.3 Data/SimData4.txt
...
// OBSOLETE g++ -std=c++0x -g -o FitWeeklyDelayDifference_v0.3 -I/usr/include /usr/lib/prob.o vonMisesRecDist.cxx FitWeeklyDelayDifference_v0.3.cxx LogLikelihoodFunction.cxx WeeklyDelayDifference.cxx `root-config --glibs --cflags` -lMinuit2
...
int main( int argc, char *argv[]) {
  ...
  std::cout << " \"Down under\" delay difference model version 0.3 (2014-05-20)\n";
  ...
  NIPY = (int) fill_from_file(FixParfilename, "Number of intervals in a year");
