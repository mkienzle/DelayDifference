...
// USAGE ./FitWeeklyDelayDifference_v0.2 Data/SimData4.txt
...
// ARGUMENT(2) this program reads fixed parameters values from a file in the local directory called FixParameters.txt
...
int main( int argc, char *argv[]) {
  ...
  // Starting message
  std::cout << " \"Down under\" delay difference model version 0.2 (2014-04-29)\n";
