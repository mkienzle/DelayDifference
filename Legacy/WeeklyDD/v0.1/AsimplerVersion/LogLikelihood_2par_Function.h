...
public:
     ...
     LogLikelihoodFunction(const std::vector<double>& catch_values,
	      const std::vector<double>& effort_values) : fCatchValues(catch_values),
	                                      fEffortValues(effort_values),
  ...
  std::vector<double> Yvalues() const {return fEffortValues;}
...
private:
  ...
  std::vector<double> fEffortValues;
