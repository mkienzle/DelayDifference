...
// USAGE ./FitMonthlyDelayDifference Data/SimData5.txt
...
// COMPILE g++ -std=c++0x -g -o FitMonthlyDelayDifference -I/usr/include /usr/lib/prob.o vonMisesRecDist.cxx FitMonthlyDelayDifference.cxx LogLikelihoodFunction.cxx MonthlyDelayDifference.cxx `root-config --glibs --cflags` -lMinuit2
...
int main( int argc, char *argv[]) {
  ...
  // Starting message
  std::cout << "Down under delay difference model version 0.1 (2014-02-03)\n";
